...
class AddParent extends Component
{
        ...
        try {
            ...
            if(!empty($this->photos))
            {
                foreach($this->photos as $file)
                {
                    ...
                    $file->storeAs('attachments/My_Parent/'.$My_Parent->Name_Father, $file->getClientOriginalName(),'upload_attachments');
    ...
    public function submitForm_edit(){
        ...
        if(!empty($this->photos))
        {
            ...
            {
                $name = $file->getClientOriginalName();
                $file->storeAs('attachments/My_Parent/'.$parent->Name_Father, $file->getClientOriginalName(),'upload_attachments');
