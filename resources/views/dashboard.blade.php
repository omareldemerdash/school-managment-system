                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.no_students') }}</p>
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Students.index') }}" target="_blank"><span
                                        class="text-danger">{{ trans('main_trans.show_informations') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.no_teachers') }}</p>
                                    <h4>{{ \App\Models\Teacher::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Teachers.index') }}" target="_blank"><span class="text-danger">{{ trans('main_trans.show_informations') }}
                                        </span></a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{ trans('main_trans.no_parents') }}</p>
                                    <h4>{{ \App\Models\My_Parent::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('add_parent') }}" target="_blank"><span class="text-danger">
                                        {{ trans('main_trans.show_informations') }}</span></a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('Sections.index') }}" target="_blank"><span class="text-danger">{{ trans('main_trans.show_informations') }}
                                        </span></a>
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">
                                            {{ trans('main_trans.latest_operations') }}</h5>
                                    </div>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="fee_invoices-tab" data-toggle="tab"
                                                    ...
                                                    aria-selected="false">{{ trans('main_trans.fees') }}
                                                </a>
                                            </li>
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                <thead>
                                                    <tr class="table-info text-danger">
                                                        ...
                                                        <th>{{ trans('Teacher_trans.created_at') }}</th>
                                                    </tr>
                                                </thead>
