                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#Graduate_one{{$promotion->id}}">تخرج الطالب</button>
                                                </td>
                                            </tr>
                                        @include('pages.Students.promotion.Delete_all')
                                        @include('pages.Students.promotion.Delete_one')
                                        @include('pages.Students.promotion.Graduate_one')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
