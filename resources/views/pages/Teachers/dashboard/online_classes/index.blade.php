            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                {{-- <a href="{{route('online_zoom_classes.create')}}" class="btn btn-success" role="button" aria-pressed="true">اضافة حصة اونلاين جديدة</a> --}} {{--if you want to integrate with zoom--}}
                                <a class="btn btn-success" href="{{route('indirect.teacher.create')}}">اضافة حصة اونلاين جديدة</a>
